...
digest_cln          = realm / domain / nonce / opaque / stale / algorithm
                      / qop_options / userhash / charset / auth_param
...
algorithm           = "algorithm"i EQUAL algorithm: ( "MD5"i / "MD5-sess"i / "SHA-256"i / "SHA-256-sess"i
                      / "SHA-512-256"i / "SHA-512-256-sess"i / token ) {
...
userhash            = "userhash"i EQUAL ( "true"i { data.userhash=true; } / "false"i { data.userhash=false; } )

charset             = "charset"i EQUAL charset: ( "UTF-8"i / token) { data.charset=charset.toUpperCase(); }
