...
const SlUtf8 = require('@stablelib/utf8');
const SlHex = require('@stablelib/hex');
const SlSha256 = require('@stablelib/sha256');
const SlSha512_256 = require('@stablelib/sha512_256');
...
exports.calculateSHA256 = s => {
	return SlHex.encode(SlSha256.hash(SlUtf8.encode(s)), true);
};

exports.calculateSHA512_256 = s => {
